...
var Header = function Header() {
  return _react.default.createElement("div", null, _react.default.createElement("h1", null, "DougSauve.com"));
};
    ...
    value: function render() {
      ...
      this.props.dests.map(function (dest) {
        return _react.default.createElement("button", {
          key: dest[0],
          onClick: _this.sendTo.bind(_this, dest[1])
        }, dest[0]);
      }));
    }
  }]);
  ...
  function Slideshow() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Slideshow.__proto__ || Object.getPrototypeOf(Slideshow)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      value: function value() {
        var maxCount = _this.props.slides.length - 1;
        var slide = _this.props.slides[_this.state.count]; // this.setState((this.prevState) > ({
        //   count: (this.prevState.count < maxCount) ? this.prevState.count + 1 : 0,
        //   slide
        // }));
      }
    }), _temp));
  ...
  _createClass(Slideshow, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("div", {
        id: "screen"
      }, _react.default.createElement("p", null, "count is ", this.state.count), _react.default.createElement("p", null, "slide is ", this.state.slide)), this.renderSlideshow());
    }
  }]);
...
var Index = function Index() {
  return _react.default.createElement("div", null, _react.default.createElement(_Header.default, null), _react.default.createElement(_NavBar.default, {
    dests: [['About', './about.js'], ['Blog', './blog.js'], ['What I can do', './projects']]
  }), _react.default.createElement(_Slideshow.default, {
    slides: ['Hi there. My name is Doug, and I build web apps.(about)', 'Take a look at what I can do. (wICD)', 'Come and see my blog.(blog)']
  }));
};
