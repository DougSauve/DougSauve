      ...
      <div className = "about__intro down__middle__flex">
        ...
        <div className = "about__pane">
          ...
          <div className = "about__item__text center">
            <p className = "drop heading">I'm really proud of this website. It's the best thing I've ever built, and I learned so much while making it.</p>
            <p className = "drop sub-heading">I said the same thing about my last project.</p>
            <p className = "drop sub-heading">I'm sure I'll say it about the next one too.</p>

            <br />

            <p className = "sub-heading purple">This is why I love what I do.</p>
          ...
          <div className = "about__item__text">
            ...
            <p className = "regular-text">
              Right now I am most excited to learn <b>React Native</b>.
              React Native is a branch of React that will allow me to create mobile apps. Most people use their phones more than their computers, and if I am going to build technology that can make a difference in people's lives, I want it to be accessible to as many people as possible.<br />
              I also want to learn more about SCSS - I love the flexibilty and organization it brings to CSS and I want to learn how to use it more effectively.
          ...
          <div className = "about__item__text">
            ...
            <p className = "regular-text">
              I enjoyed studying computer science in high school, but I decided to pursue a career as an elementary school teacher after my senior year. I learned a lot of valuable skills from it but soon learned that it wasn't going to provide me with the kind of stimulation I need. It took me a decade to get to rediscover my passion for software development and my matching skill set, and in that time I gained a large amount of experience and an eclectic range of skills. I speak <span className = "red-shadowed">French</span> and <span className = "orange-shadowed">Spanish</span>; I have <span className = "blue-shadowed">taught in three countries</span>; I am well-versed in <span className = "green-shadowed">plant lore</span>; I have co-owned a <span className = "purple-shadowed">small business</span>; I have worked in
